...
export function Alert({ title, description, type = "info", onClose, className = "" }: AlertProps) {
  const typeClasses = {
        ...
        {onClose && (
          <div className="ml-4 flex-shrink-0">
            <button
              type="button"
              onClick={onClose}
              className="inline-flex bg-transparent rounded-md text-gray-400 hover:text-gray-500 focus:outline-none"
            >
